...
class TimRestAPI extends TimRestInterface
{
    ...
    function sms_send_to_single($nationcode, $phone, $type, $msg, $sig, $ext)
    {
        #构造新消息
        $msg = array(
            "tel" => [
        ...
        $this->im_yun_url = 'yun.tim.qq.com';
        $this->version = 'v3';
        $ret = $this->api("tlssmssvr", "sendsms", $this->identifier, $this->usersig, $req_data);
        $ret = json_decode($ret, true);
        return $ret;
    }
};
